        ...
        cols: [
			...
			},
			{
                ...
                template: (d)=>{
                    ...
                    return `
                            <a href="/projects/work/workshow?gradeId=${d.id}">设置</a>
                            `;
                }
            },
			{
